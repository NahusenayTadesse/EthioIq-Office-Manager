...
export let submitButton = `w-full bg-dark hover:bg-dark hover:shadow-lg text-white font-semibold py-2 rounded-md shadow transition-all transform hover:scale-105 dark:bg-gray-800 dark:hover:bg-primary-800`;
